# Project Context — My Project (MyProject)
...
- Primary feature module: **app**
- Default source root: `app/src/main/java/com/example/myproject`
- Declared modules:
...
Configured pattern: **clean-architecture**. Domain owns repository abstractions; data implements

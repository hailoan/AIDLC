...
Act as the **Automation Test** agent in the MyProject AI-DLC pipeline.
...
| --- | --- | --- |
| Ticket id | **yes** | e.g. `PROJ-123` — resolves the ticket folder `output/<ticket>/`, which must already hold: CHANGESET.md (impl / standalone) or TEST-CASES.md (qa-flow) |
